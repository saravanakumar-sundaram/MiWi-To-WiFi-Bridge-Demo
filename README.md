...
When the EC2 instance console copied with `$ miwi_wsn_server.py` python scripts file run the python server scripts as mentioend.
 ...
 ![GitHub Logo](/Images/TCP_Server_Start.png)
...
![GitHub Logo](/Images/EC2_Instance_Public_IP_Address.JPG)
...
![GitHub Logo](/Images/TCP_Clinet_Start.png)
